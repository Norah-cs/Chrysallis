      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <a
                    key={link.href}
                    href={link.href}
                    className="group flex items-center px-4 py-3 text-base font-semibold text-gray-700 hover:text-blue-600 hover:bg-purple-50 rounded-lg transition-all duration-200 ease-in-out"
                  >
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
